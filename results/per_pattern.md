...
| pattern | n_pos | XGBoost | XGBoost+fan | GINe (base) | Multi-GNN | Эвристики |
|---|---|---|---|---|---|---|
| fan_out | 140 | 0.076 | **0.087** | 0.015 | 0.024 | 0.000 |
| fan_in | 137 | 0.064 | **0.074** | 0.030 | 0.029 | 0.000 |
| gather_scatter | 401 | 0.152 | **0.165** | 0.060 | 0.089 | 0.000 |
| scatter_gather | 252 | 0.095 | **0.099** | 0.035 | 0.060 | 0.000 |
| cycle | 109 | 0.059 | **0.066** | 0.013 | 0.013 | 0.000 |
| random | 86 | 0.029 | **0.035** | 0.008 | 0.020 | 0.000 |
| bipartite | 74 | 0.039 | **0.046** | 0.008 | 0.007 | 0.000 |
| stack | 140 | 0.063 | **0.065** | 0.025 | 0.034 | 0.000 |
| unknown | 459 | 0.072 | 0.061 | 0.018 | 0.001 | 0.003 |
